...
register_activation_hook( __FILE__, 'btaeon_install' );
...
function btaeon_menu()
{
	...
	if ( function_exists('add_menu_page') )
	{
		...
		add_menu_page('管理公告', '公告系統', $allowed_group, 'bulletaeon', 'bt_manage_msgs');
	}
	if ( function_exists('add_submenu_page') )
	{
		$admpage[0] = add_submenu_page('bulletaeon', '管理公告', '管理公告', $allowed_group, 'bulletaeon', 'bt_manage_msgs');
